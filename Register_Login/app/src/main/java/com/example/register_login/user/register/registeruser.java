...
public class registeruser {
    ...
    protected void  putDataToDB(User user, Context context){
        if (!user.getFullname().equals("")&&!user.getUsername().equals("")&&!user.getEmail().equals("")&&!user.getPassword().equals("")) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    PutData putdata = new PutData("http://10.0.2.2/player_adatb/signup.php", "POST", field, data);
